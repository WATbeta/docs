...
<Note>
Use your company email: sign-up is automatic for resident company domains. If login is refused with `NOT_AUTHORIZED`, ask a WAT admin to add your email or company domain to the list.
</Note>
