...
Don't want to run the steps yourself? Paste this into your agent and let it do everything (it will ask you for the email code, and the signup code if it's your first login):

```text
Read https://wat-887510d5.mintlify.app/agents (the WAT Rooms agent playbook)
