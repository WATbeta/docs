...
- **Web app:** one booking page — pick a room from photo cards, see its week (Monday to Sunday), click a free slot to book, and change the day right in the booking panel.
