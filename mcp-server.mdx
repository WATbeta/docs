...
| `create_booking` | Book a room, optionally inviting up to 10 guests by email (your agent confirms with you first) |
| `edit_booking` | Reschedule, retitle, or change the guest list of your booking before it starts |
